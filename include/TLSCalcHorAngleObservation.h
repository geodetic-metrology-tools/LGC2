...
public:
	...
	//@{
		...
		TLSCalcHorAngleObservation(const THorAngleMeasurement* haObs,LSOrientIter v0,
	...
	//@{
		...
		const THorAngleMeasurement*	getHorAngleObs() const {return horizontalAngleObservation;};
	...
	//@{
		...
		int			getId() const {return horizontalAngleObservation->getId();}

		/*! Returns the geode comment */
		string		getComment() const {return horizontalAngleObservation->getComment();}
...
private:
	...
	//@{
	const THorAngleMeasurement* horizontalAngleObservation;
	//@}
