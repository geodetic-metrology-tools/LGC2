...
typedef TLSCalcWorkingDistanceObservation<TLSCalcHorDistObservation> TLSCalcWorkingHorDistObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcOffsetToSpaLineObservation> TLSCalcWorkingOffsetToSpaLineObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcOffsetToTheoPlaneObservation> TLSCalcWorkingOffsetToTheoPlaneObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcOffsetToVerLineObservation> TLSCalcWorkingOffsetToVerLineObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcOffsetToVerPlaneObservation> TLSCalcWorkingOffsetToVerPlaneObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcRadialOffsetCnstrObservation> TLSCalcWorkingRadialOffsetCnstrObs;
typedef TLSCalcWorkingDistanceObservation<TLSCalcVertDistObservation> TLSCalcWorkingVertDistObs;
