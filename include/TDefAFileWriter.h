...
public:
	...
	/*!@name Constructors and Destructors*/
		...
		//@}
			...
			void	writeFile(TLGCDataSet*, const string error);
...
private:
	...
	void writeXYAnalysis(TLGCProject&);
	void writeXZAnalysis(TLGCProject&);
	void writeYZAnalysis(TLGCProject&);
	void writeXAnalysis(TLGCProject&);
	void writeYAnalysis(TLGCProject&);
	void writeZAnalysis(TLGCProject&);
