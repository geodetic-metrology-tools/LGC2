...
public:
	...
	//@{
		/*! Default constructor */
		TLSCalcGyroOrientationObservation();
		...
		TLSCalcGyroOrientationObservation(GyroOrieObsConstIter haObs,
	...
	//@{
		...
		GyroOrieObsConstIter	getGyroOrientationObs() const {return fGyroOrieObs;}
...
private:
	...
	//@{
		GyroOrieObsConstIter	fGyroOrieObs; /*!< iterator of the corresponding orientation observation (facade to spatial measurements) */
	//@}
