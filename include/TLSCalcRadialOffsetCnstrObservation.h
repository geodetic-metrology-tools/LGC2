...
public:
	...
	//@{
		...
		/*! Constructor*/
		TLSCalcRadialOffsetCnstrObservation(RadOffCnstrIterator obs, LSPosVecIter point);
	...
	//@{
		...
		RadOffCnstrIterator		getRadialOffsetCnstrObs() const { return fRadialOffsetCnstrObs;}
	...
	//@{
		...
		TAngle			getBearing() const {return fRadialOffsetCnstrObs->getCnstrBearing();}
...
private:
	...
	//@{
		...
		RadOffCnstrIterator			fRadialOffsetCnstrObs; /*!< iterator of the corresponding offset observation */
	//@}
