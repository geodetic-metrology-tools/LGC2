...
public:
	...
	//@{
		/*! Default constructor */
		TLSCalcOrientationCnstrObservation();
		/*! Constructor*/
		TLSCalcOrientationCnstrObservation(OrieCnstrObsConstIter obs, LSPosVecIter fixedPoint, LSPosVecIter refPoint);
		/*! Copy constructor */
	...
	//@{
		...
		OrieCnstrObsConstIter	getOrieCnstrObs() const { return fOrieCnstrObs; }
...
private:
	...
	//@{
		OrieCnstrObsConstIter		fOrieCnstrObs; /*!< iterator of the corresponding offset observation */
	//@}
