...
public:
	...
	//@{
		...
		/*! Indicates if the parameters for nagc statistics have been rightly chosen */
...
private:
	...
	bool		fDeltaComputed; /*!< indicates that the parameters for nagc statistics have been rightly chosen */
	string		fError;
