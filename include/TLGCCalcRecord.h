...
// **** from LSCalcDataSet: is it needed?
	...
	//@{
		...
		void				addInstrumentCalcRecord(InstrumentsCalcRecord*);

		const list<InstrumentsCalcRecord*>& getInstrumentsCalcRecords() const { return instrumentCalcRecords; }
...
private:
	...
	list<InstrumentsCalcRecord*> instrumentCalcRecords;
