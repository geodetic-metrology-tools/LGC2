...
public:
	...
	//@{
		/*! Default constructor */
		TLSCalcOffsetToTheoPlaneObservation();
		...
		TLSCalcOffsetToTheoPlaneObservation(OffsetToTheoPlaneObsConstIter obs,
	...
	//@{
		...
		OffsetToTheoPlaneObsConstIter	getOffsetToTheoPlaneObs() const { return fOffsetToTheoPlaneObs;}
	...
	//@{
		...
		TAngle				getTgAngle() const {return fOffsetToTheoPlaneObs->getTargetAngle();} 
...
private:
	...
	//@{
		OffsetToTheoPlaneObsConstIter	fOffsetToTheoPlaneObs; /*!< iterator of the corresponding offset observation */
	//@}
