...
public:
	...
	//@{
		...
		TLSCalcZenithDistObservation(const TZenithDistMeasurement* zdObs,LSLengthIter hi,TLength hp,
			LSPosVecIter st,LSPosVecIter tg, const TheodoliteStation* station);
	...
	//@{
		...
		const TZenithDistMeasurement*	getZenDistObs() const { return fZenDistObs; }
...
private:
	...
	//@{
		const TZenithDistMeasurement* fZenDistObs; /*!< iterator to the corresponding zenithal angle observation (facade to spatial measurements) */
	//@}
