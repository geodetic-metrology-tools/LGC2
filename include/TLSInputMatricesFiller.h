...
static const double scaleK = 1e-5;
...
public :	
	...
	virtual bool 		fillMatrices(const LSCalcDataSet&,TLSInputMatrices&);

	//! initialise the dimensions of the input matrices
	void		initMatriceDimension(const LSCalcDataSet&,TLSInputMatrices&);
...
private:
	...
	//@{
		...
		void		addHorAngContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the zenithal angle observations */
		void		addZenDistContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the spatial dist. observations */
		void		addSpaDistContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the hor. dist. observations */
		void		addHorDistContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the vertical dist. observations */
		void		addVertDistContributions(const LSCalcDataSet&, TLSInputMatrices&, bool isDLEV);
		/*! Add the design matrices contributions for the offset to ver. line observations */
		void		addOffsetToVerLineContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the offset to spa. line observations */
		void		addOffsetToSpaLineContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the offset to ver. plane observations */
		void		addOffsetToVerPlaneContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the offset to theo. plane observations */
		void		addOffsetToTheoPlaneContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the gyro. orientation observations */
		void		addGyroOrieContributions(const LSCalcDataSet&, TLSInputMatrices&);
		
		/*! Add the design matrices contributions for the radial offset constraints */
		void		addRadOffCnstrContributions(const LSCalcDataSet&, TLSInputMatrices&);
		
		/*! Add the design matrices contributions for the orientation constraints */
		void		addOrieCnstrContributions(const LSCalcDataSet&, TLSInputMatrices&);
		/*! Add the design matrices contributions for the constraints of a free network calculation */
		void		addFreeCnstrContributions(const LSCalcDataSet&, TLSInputMatrices&, TLSConstraintIdentifier& cnstr);
	...
	//@{
		...
		void		processFreeCnstr(const LSCalcDataSet&, TLSInputMatrices&, const TLSConstraintIdentifier& cnstr);
	//@}
