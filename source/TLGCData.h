...
struct TMeasurementsGlobal{
	enum EMeasurementType{kANGL, kZEND, kDIST, kPLR3D, kDIR3D, kDLEV, kDHOR, kECTH, kDSPT, kDVER};
...
public:
	...
	*/
	...
	TFileLogger fOutputFileWriter;

	void setCombinedCaseCalcUsed() {fCombinedCase = true;}

	bool combinedCaseUsed() {return fCombinedCase;}
