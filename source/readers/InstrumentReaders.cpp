...
TAKeyINSTR::TAKeyINSTR(TLGCData& project, const std::string& key) : 
	...
	finstruments(project.instruments), fscalars(project.scalars), fangles(project.angles) 
	{}



TKeyINSTR::TKeyINSTR(TLGCData& project) : TAKeyWord("INSTR", project) 
	{}
...
// POLAR instrument //
//////////////////////
TKeyPOLAR::TKeyPOLAR(TLGCData& project): TAKeyINSTR(project, "POLAR") {}
...
// EDM instrument //
////////////////////
TKeyEDM::TKeyEDM(TLGCData& project) : TAKeyINSTR(project, "EDM") {}
...
// LEVEL instrument //
//////////////////////
TKeyLEVEL::TKeyLEVEL(TLGCData& project) : TAKeyINSTR(project, "LEVEL") {}
...
// SCALE instrument //
//////////////////////
TKeySCALE::TKeySCALE(TLGCData& project) : TAKeyINSTR(project, "SCALE") {}
