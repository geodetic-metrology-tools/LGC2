...
void TKeyTITR::parse(const std::vector<const std::string>& tokens, int) {
	if (tokens.size() != 3)
...
///////////////////////////////////////////////////////
TKeyCALA::TKeyCALA(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, CALA) 
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
...
TKeyPOIN::TKeyPOIN(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, POIN)
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
...
TKeyVXY::TKeyVXY(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, VXY)
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
...
TKeyVXZ::TKeyVXZ(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, VXZ) 
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
...
TKeyVYZ::TKeyVYZ(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, VYZ) 
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
...
TKeyVZ::TKeyVZ(TLGCData& project, int nb_allowed_keywords, const char** keywords) : TKeyPoint(project, VZ) 
{			
	for(int i(0) ; i< nb_allowed_keywords ; i++)
		allowed_keywords.emplace_back(keywords[i]);
}
