...
/*!
	This class contains the configuration options of the input file. 
	...
	*/
	class TSimulation : public TBinaryOption {
		public:
			...
			int  numSims;
			/// Measurements may be present in the input file but they are ignored
			bool ignoreMeasurements;
			...
			TSimulation() : 
				TBinaryOption(),
				numSims(0),
				ignoreMeasurements(false),
				writeLGCFile(false),
				newInfileHasMeasurements(false) {}
			/*! 
				This constructor sets the default values for enabled simulations.

				\param n The number of simulations to run
				\param ignoreMeas The measurement values in the input file are ignored
			*/
			TSimulation(int n, bool ignoreMeas) :
				TBinaryOption(true),
				numSims(n),
				ignoreMeasurements(ignoreMeas),
				writeLGCFile(false),
				newInfileHasMeasurements(false) {}
	};
	...
	*/
	class TFautDetect : public TBinaryOption {
		public:
			...
			/*! 
				Enables the blunder detection module with given quantiles.
	...
	*/
	class TPDOR : public TBinaryOption {
		public:
			...
			TPDOR() : TBinaryOption() {}
			/*!
				Adds an orientation point to the adjustment with an optional gisement.
