...
namespace tut
{
	...
	void object::test<2>()
	{
		...
		TPositionVector PT2 = proj.points.getObject("PT2").getEstimatedValue();
		...
		TPositionVector STN2 = proj.points.getObject("STN2").getEstimatedValue();
		...
		TPositionVector P4 = proj.points.getObject("P4").getEstimatedValue();
		...
		TPositionVector REF = proj.points.getObject("REF").getEstimatedValue();
