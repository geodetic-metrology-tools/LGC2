...
namespace TestROOT {
	...
	*/
	...
	/* 
		TEST TWO TOTAL STATIONS : DIRECT3D
		Two Total Station looking two variable points and a Cala point
		Direct3D & distance coordinates are measured by total stations
		z values are in the same plane
	*/
	char const *const DIR3D_setup4 = 
		"*TITR\n"
		"Testing Input Matrices Filler.\n"
		"*OLOC\n"
		"*FAUT\n"
...
*/
	...
	*/
	char const *const Param_setup4_different_z = 
		"*TITR\n"
		"Testing Input Matrices Filler.\n"
		"*OLOC\n"
		"*FAUT\n"
	...
	/* 
		...
		z values are in a different plane
	*/
	char const *const PLR3D_setup4_different_z = 
		"*TITR\n"
		"Testing Input Matrices Filler.\n"
		"*OLOC\n"
		"*FAUT\n"
	...
	/* 
		...
		Direct3D & distance coordinates are measured by total stations
	*/
	char const *const DIR3D_setup4_different_z = 
		"*TITR\n"
		"Testing Input Matrices Filler.\n"
		"*OLOC\n"
		"*FAUT\n"
		...
		"*TSTN PT2 TS1 IHFIX\n"
		  "*V0\n"
			"*DIR3D\n"
				"STN  240 100.450150655667\n"
				"REF 190 100.636598552981\n"
				"PT 290 100\n"
			"*DIST\n"
				"STN 141.424891727\n"
				"REF 100.004999875\n"
		...
		;
	char const *const DIR3D_new_test_driect = 
		"*TITR\n"
		"Testing Input Matrices Filler.\n"
		"*OLOC\n"
		"*FAUT\n"
