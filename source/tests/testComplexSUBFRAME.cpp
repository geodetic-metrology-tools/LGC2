...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void object::test<2>()
	{
		...
		TDataTreeIterator it = dataset.tree.begin();
		it++;
	...
	void object::test<4>()
	{
		...
		TReader r(&projTest);
		projTest.fOutputFileWriter.setOutputfileLocation("C:/Temp/outputPLR111.txt");
		projTest.fOutputFileWriter.writeReportHeader("LGC output file");
...
//////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void object::test<6>()
	{
		...
		TReader r(&projTest);
		projTest.fOutputFileWriter.setOutputfileLocation("C:/Temp/outputDIR3D.txt");
		projTest.fOutputFileWriter.writeReportHeader("LGC output file");
