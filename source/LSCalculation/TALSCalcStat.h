...
#ifndef SU_ABSTRACT_LSCALC_STAT
#define SU_ABSTRACT_LSCALC_STAT
...
public:
	...
	//@{
		...
		TALSCalcStat();
		/*! Copy constructor */
		TALSCalcStat(const TALSCalcStat& source);
		/*! Destructor */
		virtual ~TALSCalcStat();
	//@}
...
protected :
		...
		/*! Compute and return the overall network reliability as a double */
		//double computeOverallNetworkReliability(TLGCData* projData);  //TO DO
...
private:
	...
	//double		fOVERALL; /*!< Value for the overall network reliability  */
