...
char const *const INCLY_ROOT_1 = "*TITR\n"
								 "T1\n"
								 "*OLOC\n"
								 "*INSTR\n"
...
*/
char const *const INCLY_SUBF_1 = "*TITR\n"
								 "T2\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const INCLY_SUBF_2 = "*TITR\n"
								 "T3\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const INCLY_SUBF_3 = "*TITR\n"
								 "T4\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const INCLY_SUBF_4 = "*TITR\n"
								 "T5\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const INCLY_SUBF_5 = "*TITR\n"
								 "T6\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const INCLY_SUBF_5_id = "*TITR\n"
									"T6\n"
									"*RS2K\n"
									"*PREC 7\n"
									"*INSTR\n"
...
char const *const INCLY_SUBF_4_xyzID = "*TITR\n"
									   "T5\n"
									   "*RS2K\n"
									   "*PREC 7\n"
									   "*INSTR\n"
...
char const *const INCLY_CONTRIB = "*TITR \n"
								  "test Contrib Incl \n"
								  "*OLOC \n"
								  "*INSTR \n"
								  "*INCL I   5  0  0   0  0  0 \n"
...
char const *const ROLLY_LEGACY_ROOT_1 = "*TITR\n"
								 "T1\n"
								 "*OLOC\n"
								 "*INSTR\n"
								 "*INCL test 35 0 0 0 0 0 \n"
...
char const *const ROLLY_LEGACY_SUBF_1 = "*TITR\n"
								 "T2\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_2 = "*TITR\n"
								 "T3\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_3 = "*TITR\n"
								 "T4\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_4 = "*TITR\n"
								 "T5\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_5 = "*TITR\n"
								 "T6\n"
								 "*RS2K\n"
								 "*PREC 7\n"
								 "*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_5_id = "*TITR\n"
									"T6\n"
									"*RS2K\n"
									"*PREC 7\n"
									"*INSTR\n"
...
char const *const ROLLY_LEGACY_SUBF_4_xyzID = "*TITR\n"
									   "T5\n"
									   "*RS2K\n"
									   "*PREC 7\n"
									   "*INSTR\n"
...
char const *const ROLLY_LEGACY_CONTRIB = "*TITR \n"
								  "test Contrib ROLLY \n"
								  "*OLOC \n"
								  "*INSTR \n"
								  "*INCL I   5  0  0   0  0  0 \n"
