...
void runComplexFrameEdgeCaseTest(const ComplexFrameEdgeCaseParams &params, std::shared_ptr<TLGCData> projTest, TReader &r)
{
	...
	for (size_t i = 0; i < tree.size(); ++i)
	{
		...
		if (!frameIt.node->data->measurements.fINCLY.empty() || !frameIt.node->data->measurements.fROLLY.empty())
		{
...
void object::test<1>()
{
	...
	RootErrorTestParams params = {TestINCL::INCLY_ROOT_1, "C:/Temp/INCLY_ROOT_1.txt", "Testing INCLY, 1 STATION in root", "INCLY"};
...
void object::test<2>()
{
	...
	RootErrorTestParams params = {TestINCL::ROLLY_LEGACY_ROOT_1, "C:/Temp/ROLLY_LEGACY_ROOT_1.txt", "Testing ROLLY, 1 STATION in root", "ROLLY"};
...
void object::test<3>()
{
	...
	IDValidationTestParams params = {TestINCL::INCLY_SUBF_5_id, "C:/Temp/INCLY_SUBF_5_id.txt", "Testing INCLY ID reading", "INCLY"};
...
void object::test<4>()
{
	...
	IDValidationTestParams params = {TestINCL::ROLLY_LEGACY_SUBF_5_id, "C:/Temp/ROLLY_LEGACY_SUBF_5_id.txt", "Testing ROLLY ID reading", "ROLLY"};
...
void object::test<5>()
{
	...
	OBSXYZIDValidationTestParams params = {
		TestINCL::INCLY_SUBF_4_xyzID, "C:/Temp/INCLY_SUBF_4_xyzID.txt", "Testing INCLY context OBSXYZ ID reading", "INCLY", "XYZ.BEAM_XT03.BDB.0900.E",
...
void object::test<6>()
{
	...
	OBSXYZIDValidationTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_4_xyzID, "C:/Temp/ROLLY_LEGACY_SUBF_4_xyzID.txt", "Testing ROLLY context OBSXYZ ID reading", "ROLLY", "XYZ.BEAM_XT03.BDB.0900.E",
		4 // Frame iterations: ROOT -> RSTB -> RSTB2 -> RSTRI -> RSTR
	};
...
void object::test<7>()
{
	...
	TransformationTestParams params = {
		TestINCL::INCLY_CONTRIB, "C:/Temp/INCLY_CONTRIB.txt", "Testing INCLY arcsin model derivatives", "INCLY",
...
void object::test<8>()
{
	...
	TransformationTestParams params = {
		TestINCL::ROLLY_LEGACY_CONTRIB, "C:/Temp/ROLLY_LEGACY_CONTRIB.txt", "Testing ROLLY atan2 model derivatives", "ROLLY",
		0.0, // Expected S0 (perfect fit)
		-1.0, -1.0, -1.0, // Expected translations (TX, TY, TZ)
		0.0, 0.0, 0.0, // Expected rotations (RX, RY, RZ)
		1.0, // Expected scale
...
void object::test<9>()
{
	...
	INSTRTestParams params = {
		TestINCL::INCLY_SUBF_8, "C:/Temp/INCLY_SUBF_8.txt", "Testing INCLY INSTR keyword functionality", "INCLY",
...
void object::test<10>()
{
	...
	INSTRTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_8, "C:/Temp/ROLLY_LEGACY_SUBF_8.txt", "Testing ROLLY INSTR keyword functionality", "ROLLY",
		{"I1", "I2", "I1"}, // Expected instrument sequence: default -> override -> default
		1 // Target frame iterations (ROOT -> TEST)
	};
...
void object::test<11>()
{
	...
	ExtremeAngleEdgeCaseParams params = {TestINCL::INCLY_EDGE_CASE_EXTREME_ANGLES, "C:/Temp/INCLY_EDGE_CASE_EXTREME_ANGLES.txt", "INCLY Edge Case - Extreme Angles Test", "INCLY"};
...
void object::test<12>()
{
	...
	ExtremeAngleEdgeCaseParams params = {TestINCL::ROLLY_EDGE_CASE_EXTREME_ANGLES, "C:/Temp/ROLLY_EDGE_CASE_EXTREME_ANGLES.txt", "ROLLY Edge Case - Extreme Angles Test", "ROLLY"};
...
void object::test<13>()
{
	...
	UnusualParameterEdgeCaseParams params = {
		TestINCL::INCLY_EDGE_CASE_UNUSUAL_PARAMS, "C:/Temp/INCLY_EDGE_CASE_UNUSUAL_PARAMS.txt", "INCLY Edge Case - Unusual Parameter Combinations Test", "INCLY"};
...
void object::test<14>()
{
	...
	UnusualParameterEdgeCaseParams params = {
		TestINCL::ROLLY_EDGE_CASE_UNUSUAL_PARAMS, "C:/Temp/ROLLY_EDGE_CASE_UNUSUAL_PARAMS.txt", "ROLLY Edge Case - Unusual Parameter Combinations Test", "ROLLY"};
...
void object::test<15>()
{
	...
	ComplexFrameEdgeCaseParams params = {
		TestINCL::INCLY_EDGE_CASE_COMPLEX_FRAMES, "C:/Temp/INCLY_EDGE_CASE_COMPLEX_FRAMES.txt", "INCLY Edge Case - Complex Frame Transformations Test", "INCLY"};
...
void object::test<16>()
{
	...
	ComplexFrameEdgeCaseParams params = {
		TestINCL::ROLLY_EDGE_CASE_COMPLEX_FRAMES, "C:/Temp/ROLLY_EDGE_CASE_COMPLEX_FRAMES.txt", "ROLLY Edge Case - Complex Frame Transformations Test", "ROLLY"};
...
void object::test<17>()
{
	...
	ReferencePointEdgeCaseParams params = {TestINCL::INCLY_EDGE_CASE_REF_POINTS, "C:/Temp/INCLY_EDGE_CASE_REF_POINTS.txt", "INCLY Edge Case - Reference Point Scenarios Test", "INCLY"};
...
void object::test<18>()
{
	...
	ReferencePointEdgeCaseParams params = {TestINCL::ROLLY_EDGE_CASE_REF_POINTS, "C:/Temp/ROLLY_EDGE_CASE_REF_POINTS.txt", "ROLLY Edge Case - Reference Point Scenarios Test", "ROLLY"};
...
void object::test<19>()
{
	...
	ModelComparisonTestParams params = {
		TestINCL::INCLY_VS_ROLLY_MODEL_TEST, "C:/Temp/INCLY_VS_ROLLY_MODEL_TEST.txt", "Mathematical Model Comparison Test", "Medium angles (RX=0.1, RY=0.2 gon)",
...
void object::test<20>()
{
	...
	ModelComparisonTestParams params = {
		TestINCL::INCLY_VS_ROLLY_TEST_CASE_1, "C:/Temp/INCLY_VS_ROLLY_TEST_CASE_1.txt", "Small angles (RX=0.05, RY=0.1 gon)", "Small angles (RX=0.05, RY=0.1 gon)",
...
void object::test<21>()
{
	...
	ModelComparisonTestParams params = {
		TestINCL::INCLY_VS_ROLLY_TEST_CASE_2, "C:/Temp/INCLY_VS_ROLLY_TEST_CASE_2.txt", "Medium angles (RX=0.2, RY=0.5 gon)", "Medium angles (RX=0.2, RY=0.5 gon)",
		1e-6, // Expected minimum difference for medium angles
...
void object::test<22>()
{
	...
	ModelComparisonTestParams params = {
		TestINCL::INCLY_VS_ROLLY_TEST_CASE_3, "C:/Temp/INCLY_VS_ROLLY_TEST_CASE_3.txt", "Large angles (RX=0.5, RY=1.0 gon)", "Large angles (RX=0.5, RY=1.0 gon)",
...
void object::test<23>()
{
	...
	KeywordValidationTestParams params = {TestINCL::INCLY_KEYWORD_VALIDATION_TEST, "C:/Temp/INCLY_KEYWORD_VALIDATION_TEST.txt", "INCLY Keyword Validation Test", expectedMeasurements};
...
void object::test<24>()
{
	...
	KeywordValidationTestParams params = {TestINCL::ROLLY_KEYWORD_VALIDATION_TEST, "C:/Temp/ROLLY_KEYWORD_VALIDATION_TEST.txt", "ROLLY Keyword Validation Test", expectedMeasurements};
...
void object::test<26>()
{
	...
	SubframeTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_1, "C:/Temp/ROLLY_LEGACY_SUBF_1.txt", "CALA declared in the same frame", "BEAM_XT03.BDB.0900.S", 1744.83305121, 2369.92086569,
		2537.43615388, 3, "ROLLY",
...
void object::test<28>()
{
	...
	SubframeTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_2, "C:/Temp/ROLLY_LEGACY_SUBF_2.txt", "CALA declared in the root", "BEAM_XT03.BDB.0900.S", 1744.83305121, 2369.92086569, 2537.43615388, 3, "ROLLY",
		1e-7, // High precision tolerance for coordinates
		1e-7 // High precision tolerance for rotation
	};
	runSubframeTest(params, projTest, r);
...
void object::test<30>()
{
	...
	SubframeTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_3, "C:/Temp/ROLLY_LEGACY_SUBF_3.txt", "Station moving declared in another frame", "BEAM_XT03.BDB.0900.S", 1744.83305121,
		2369.92086569, 2537.43615388, 3, "ROLLY",
		1e-7, // High precision tolerance for coordinates
		1e-7 // High precision tolerance for rotation
	};
	runSubframeTest(params, projTest, r);
...
void object::test<32>()
{
	...
	SubframeTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_4, "C:/Temp/ROLLY_LEGACY_SUBF_4.txt", "Station moving declared in another frame, more complex structure", "BEAM_XT03.BDB.0900.S",
		1744.83305121, 2369.92086569, 2537.43615388, 4, "ROLLY",
		1e-7, // High precision tolerance for coordinates
		1e-7 // High precision tolerance for rotation
	};
	runSubframeTest(params, projTest, r);
...
void object::test<34>()
{
	...
	SubframeTestParams params = {
		TestINCL::ROLLY_LEGACY_SUBF_5, "C:/Temp/ROLLY_LEGACY_SUBF_5.txt", "marginal changes if station not far", "BEAM_XT03.BDB.0900.S", 1744.83305121, 2369.92086569,
		2537.43615388, 3, "ROLLY",
...
/*
 * Test INCLY reference angle: comparing subframe approach vs RF keyword
 *
 * Validates that freeFrame1 (using a reference angle subframe) and freeFrame2 (using RF keyword)
 * produce the same estimated frame parameters and measurement residuals.
 */
template<>
template<>
void object::test<35>()
{
	set_test_name("Testing INCLY reference angle: subframe vs RF keyword");

	std::stringstream infiler(TestINCL::INCLY_REF_ANGLE_TEST);
	ensure_equals("Reading successful", r.read(infiler), true);

	TLGCCalculation calcul(projTest);
	Behavior successCalc = calcul.computeResults(nullptr);
	ensure_equals("Calculation successful", successCalc.code(), Behavior::BehaviorCode::ERR_noError);

	const TLGCData &dataset = calcul.getData();

	// Locate frames
	auto &frame1 = dataset.locateNode("freeFrame1").node->data->frame;
	auto &frame2 = dataset.locateNode("freeFrame2").node->data->frame;

	// Compare estimated translations and rotations
	for (int i = 0; i < 3; ++i)
	{
		ensure_equals("Translation mismatch", frame1.getEstTranslation(i).getMetresValue(), frame2.getEstTranslation(i).getMetresValue(), 1e-6);
		ensure_equals("Rotation mismatch", frame1.getEstRotation(i).getRadiansValue(), frame2.getEstRotation(i).getRadiansValue(), 1e-6);
	}

	// Compare INCLY residuals: referenceAngle subframe vs freeFrame2 with RF keyword
	auto &meas1 = dataset.locateNode("referenceAngle").node->data->measurements.fINCLY;
	auto &meas2 = dataset.locateNode("freeFrame2").node->data->measurements.fINCLY;
	ensure("INCLY measurements present", !meas1.empty() && !meas2.empty());

	TReal residual1 = meas1.begin()->measINCLY.begin()->getAngleResidual().getRadiansValue();
	TReal residual2 = meas2.begin()->measINCLY.begin()->getAngleResidual().getRadiansValue();
	ensure_equals("INCLY residuals should match", residual1, residual2, 1e-6);

	// Verify ROLLY RF in math model: calcMeas with RF = calcMeas without RF + RF
	// calcMeas = observed + residual
	auto &rollyMeas = dataset.locateNode("freeFrame3").node->data->measurements.fROLLY;
	ensure("ROLLY measurements present", !rollyMeas.empty());

	auto rollyIt = rollyMeas.begin()->measROLLY.begin();
	TAngle refAngle = rollyIt->target.refAngleCorrectionValue;
	TAngle calcMeasWithRF = rollyIt->getAngle() + rollyIt->getAngleResidual();
	++rollyIt;
	TAngle calcMeasWithoutRF = rollyIt->getAngle() + rollyIt->getAngleResidual();

	ensure_equals("ROLLY calcMeas with RF = calcMeas without RF + RF", calcMeasWithRF.getGonsValue(), (calcMeasWithoutRF + refAngle).getGonsValue(), 1e-6);

	// Verify INCLY RF in math model: calcMeas with RF = calcMeas without RF + RF
	// for INCLY this property only holds for pure rotations around y axis, freeFrame4 has 0 rotation around x and z axis
	auto &inclyMeas = dataset.locateNode("freeFrame4").node->data->measurements.fINCLY;
	ensure("INCLY measurements in freeFrame4 present", !inclyMeas.empty());

	auto inclyIt = inclyMeas.begin()->measINCLY.begin();
	TAngle inclyRefAngle = inclyIt->target.refAngleCorrectionValue;
	TAngle inclyCalcMeasWithRF = inclyIt->getAngle() + inclyIt->getAngleResidual();
	++inclyIt;
	TAngle inclyCalcMeasWithoutRF = inclyIt->getAngle() + inclyIt->getAngleResidual();

	ensure_equals("In case instrument frame is Root + pure rotation around y axis: INCLY calcMeas with RF = calcMeas without RF + RF", inclyCalcMeasWithRF.getGonsValue(),
		(inclyCalcMeasWithoutRF + inclyRefAngle).getGonsValue(), 1e-6);
}

/*
 * Test 36: INCLY/ROLLY derivative correctness for non-unit scale
 *
 * With correct derivatives (properly accounting for normalization in the chain rule),
 * the estimated precision of RY should equal the instrument sigma.
 */
template<>
template<>
void object::test<36>()
{
	set_test_name("Testing INCLY/ROLLY derivative for non-unit scale");

	std::stringstream infiler(TestINCL::INCLY_SCALE_DERIVATIVE_TEST);
	ensure_equals("Reading successful", r.read(infiler), true);

	TLGCCalculation calcul(projTest);
	ensure_equals("Calculation successful", calcul.computeResults(nullptr).code(), Behavior::BehaviorCode::ERR_noError);

	const TLGCData &dataset = calcul.getData();

	// INCLY
	auto &frame1 = dataset.locateNode("freeFrame1").node->data->frame;
	auto &incly = *dataset.locateNode("freeFrame1").node->data->measurements.fINCLY.begin()->measINCLY.begin();
	ensure_equals("INCLY: Estimated RY = observation", frame1.getEstRotation(1).getGonsValue(), incly.getAngle().getGonsValue(), 1e-6);
	ensure_equals("INCLY: RY precision = instrument sigma", frame1.getEstimatedPrecisionRot(1).getGonsValue(), incly.target.sigmaAngl.getGonsValue(), 0.01);

	// ROLLY
	auto &frame2 = dataset.locateNode("freeFrame2").node->data->frame;
	auto &rolly = *dataset.locateNode("freeFrame2").node->data->measurements.fROLLY.begin()->measROLLY.begin();
	ensure_equals("ROLLY: Estimated RY = observation", frame2.getEstRotation(1).getGonsValue(), rolly.getAngle().getGonsValue(), 1e-6);
	ensure_equals("ROLLY: RY precision = instrument sigma", frame2.getEstimatedPrecisionRot(1).getGonsValue(), rolly.target.sigmaAngl.getGonsValue(), 0.01);
}
