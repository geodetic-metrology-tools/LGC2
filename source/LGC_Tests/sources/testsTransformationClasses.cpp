...
void object::test<5>()
{
	...
	double x_expected = directTransfo.getMmatrixIJPosition(0, 0) * 10 + directTransfo.getMmatrixIJPosition(0, 1) * 3.0 + directTransfo.getMmatrixIJPosition(0, 2) * -1.0
		+ directTransfo.getMmatrixIJPosition(0, 3) * 1;
	double y_expected = directTransfo.getMmatrixIJPosition(1, 0) * 10 + directTransfo.getMmatrixIJPosition(1, 1) * 3.0 + directTransfo.getMmatrixIJPosition(1, 2) * -1.0
		+ directTransfo.getMmatrixIJPosition(1, 3) * 1;
	double z_expected = directTransfo.getMmatrixIJPosition(2, 0) * 10 + directTransfo.getMmatrixIJPosition(2, 1) * 3.0 + directTransfo.getMmatrixIJPosition(2, 2) * -1.0
		+ directTransfo.getMmatrixIJPosition(2, 3) * 1;
...
void object::test<6>()
{
	...
	ensure_distance("m(0,3)", invTransfo.getMmatrixIJPosition(0, 3),
		-(kappacos * phicos) * param1.tX.getMetresValue() - (kappacos * phisin * omegasin - kappasin * omegacos) * param1.tY.getMetresValue()
			- (kappacos * phisin * omegacos + kappasin * omegasin) * param1.tZ.getMetresValue(),
		1e-6);
	...
	ensure_distance("m(1,3)", invTransfo.getMmatrixIJPosition(1, 3),
		-(kappasin * phicos) * param1.tX.getMetresValue() - (kappasin * phisin * omegasin + kappacos * omegacos) * param1.tZ.getMetresValue()
			- (kappasin * phisin * omegacos - kappacos * omegasin) * param1.tZ.getMetresValue(),
		1e-6);
	...
	ensure_distance("m(2,3)", invTransfo.getMmatrixIJPosition(2, 3),
		-(-phisin) * param1.tX.getMetresValue() - (phicos * omegasin) * param1.tY.getMetresValue() - (phicos * omegacos) * param1.tZ.getMetresValue(), 1e-6);
}
...
void object::test<10>()
{
	...
	ensure_distance("m(1,2)", invTransfo.getMmatrixIJPosition(1, 2), kappasin * phisin * omegacos - kappacos * omegasin, 1e-6);
	ensure_distance("m(1,3)", invTransfo.getMmatrixIJPosition(1, 3),
		-(kappasin * phicos) * param1.tX.getMetresValue() - (kappasin * phisin * omegasin + kappacos * omegacos) * param1.tY.getMetresValue()
			- (kappasin * phisin * omegacos - kappacos * omegasin) * param1.tZ.getMetresValue(),
		1e-6);
	ensure_distance("m(2,0)", invTransfo.getMmatrixIJPosition(2, 0), -phisin, 1e-6);
	ensure_distance("m(2,1)", invTransfo.getMmatrixIJPosition(2, 1), phicos * omegasin, 1e-6);
...
void object::test<18>()
{
	...
	ensure_distance("m(0,3)", derivTransfo.getMmatrixIJPosition(0, 3),
		-(kappacos * phicos) * param1.tX.getMetresValue() - (kappacos * phisin * omegasin - kappasin * omegacos) * param1.tY.getMetresValue()
			- (kappacos * phisin * omegacos + kappasin * omegasin) * param1.tZ.getMetresValue(),
		1e-6);
	...
	ensure_distance("m(1,3)", derivTransfo.getMmatrixIJPosition(1, 3),
		-(kappasin * phicos) * param1.tX.getMetresValue() - (kappasin * phisin * omegasin + kappacos * omegacos) * param1.tY.getMetresValue()
			- (kappasin * phisin * omegacos - kappacos * omegasin) * param1.tZ.getMetresValue(),
		1e-6);
	...
	ensure_distance("m(2,3)", derivTransfo.getMmatrixIJPosition(2, 3),
		-(-phisin) * param1.tX.getMetresValue() - (phicos * omegasin) * param1.tY.getMetresValue() - (phicos * omegacos) * param1.tZ.getMetresValue(), 1e-6);
