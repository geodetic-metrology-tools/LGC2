...
void object::test<1>()
{
	...
	ensure_equals("Estimated value of Z(H is fixed) have to change, because it depends on X a Y which has changed", pH.getEstimatedValue().getZ().getMetresValue(),
		2002.73661251304, 1e-8);
