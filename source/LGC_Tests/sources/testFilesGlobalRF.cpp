...
void object::test<7>()
{
	...
	// APPARENTLY IT IS LINED TO THE INTRODUCTION OF SECOND STATION, but I think it is BECAUSE IT IS NOT EXACTLY AT P0 and THEREFORE THERE ARE THESE DIFFERENCES IN Z AND
	// V0 PROBABLY ALL RIGHT, because ITS IS TEH SAME IF I HAVE ONLY ONE STATION WHICH IS NOT AT P0
