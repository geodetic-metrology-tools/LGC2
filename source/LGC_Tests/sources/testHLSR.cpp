...
namespace tut
{
	...
	void object::test<6>()
	{
		...
		measIt++;
		ensure_equals("Second measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_2");
		ensure_equals("Second measurement: Sigma Dist should match", measIt->target.sigmaDist, 0.05 / 1000, 1e-7);
		ensure_equals("Second measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0.02 / 1000, 1e-7);
		ensure_equals("Second measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 1.0 / 1000, 1e-7);
		ensure_equals("Second measurement: Sigma Water Surface should match", measIt->target.sigmaWS, 0.02 / 1000, 1e-7);
		measIt++;
		measIt++;
		ensure_equals("Fourth measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_2");
		ensure_equals("Fourth measurement: Sigma Dist should match", measIt->target.sigmaDist, 1.0 / 1000, 1e-7);
		ensure_equals("Fourth measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0.02 / 1000, 1e-7);
		ensure_equals("Fourth measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 1.0 / 1000, 1e-7);
		ensure_equals("Fourth measurement: Sigma Water Surface should match", measIt->target.sigmaWS, 0.02 / 1000, 1e-7);
		measIt++;
		ensure_equals("Fifth measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_2");
		ensure_equals("Fifth measurement: Sigma Dist should match", measIt->target.sigmaDist, 0.05 / 1000, 1e-7);
		ensure_equals("Fifth measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 2.0 / 1000, 1e-7);
		ensure_equals("Fifth measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 1.0 / 1000, 1e-7);
		ensure_equals("Fifth measurement: Sigma Water Surface should match", measIt->target.sigmaWS, 0.02 / 1000, 1e-7);
		measIt++;
		ensure_equals("Sixth measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_2");
		ensure_equals("Sixth measurement: Sigma Dist should match", measIt->target.sigmaDist, 0.05 / 1000, 1e-7);
		ensure_equals("Sixth measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0.02 / 1000, 1e-7);
		...
		measIt++;
		ensure_equals("Seventh measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_2");
		ensure_equals("Seventh measurement: Sigma Dist should match", measIt->target.sigmaDist, 0.05 / 1000, 1e-7);
		ensure_equals("Seventh measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0.02 / 1000, 1e-7);
		ensure_equals("Seventh measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 1.0 / 1000, 1e-7);
		ensure_equals("Seventh measurement: Sigma Water Surface should match", measIt->target.sigmaWS, 4.0 / 1000, 1e-7);
		measIt++;
		measIt++;
		ensure_equals("Nineth measurement: Instrument name should match", measIt->target.ID, "HL_SNSR_1");
		ensure_equals("Nineth measurement: Sigma Dist should match", measIt->target.sigmaDist, 0.03 / 1000, 1e-7);
		ensure_equals("Nineth measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0, 1e-7);
		ensure_equals("Nineth measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 0, 1e-7);
		...
		ensure_equals("Tenth measurement: Sigma Instr Height should match", measIt->target.sigmaInstrHeight, 0, 1e-7);
		ensure_equals("Tenth measurement: Sigma Instr Centering should match", measIt->target.sigmaInstrCentering, 0, 1e-7);
