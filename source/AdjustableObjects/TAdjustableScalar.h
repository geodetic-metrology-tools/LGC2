...
public:
	...
	//@{
		...
		/*!
			...
			\returns The number of unknowns of this scalar.
		*/
		inline virtual int getNumUkn() const { return (int)!isScalarFixed;}
		...
		*/
		inline virtual bool isInitialized() const { return !_isnan(fProvisionalValue.getValue());;}
