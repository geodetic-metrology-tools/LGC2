...
class TVAdjustableObject {
	public:
		...
		/*!
			...
			\returns The number of unknowns for this object.
		*/
		virtual int   getNumUkn() const = 0;		
		...
		*/
		...
		/*!
			Get the name (which serves as an ID in most cases) of the adjustable object. This can be a name of: point, line, plane, scalar, angle or HelmertTransformation.
		*/
