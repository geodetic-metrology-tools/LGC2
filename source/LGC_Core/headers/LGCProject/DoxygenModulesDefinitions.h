...
/** \defgroup Measurements
   ...
   Some measurements does not belong to any of these stations (in the input file, there is no station definition) and structures representing round of measurements of
   these observations are defined (TECHOROM, TORIEROM).
...
\ingroup SurveyLib
\brief Basically not used, some of them initialized in the TRefSystemFactory. Almost everything can be deleted, left just for the dependecies reasons. Classes not
attached here, but see the LGC2 ReferenceSurfaces project.
*/
