...
private:
	...
	//! Assigns both the equation and the observation indices of a single measurement
	//! (convenience composition of \ref assignEqIndex and \ref assignObsIndex).
	template<typename TMeas>
	void assignEOIndex(TMeas &meas);
