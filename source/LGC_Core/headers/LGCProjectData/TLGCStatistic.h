...
#if USE_SERIALIZER
/*!
	\brief JSON representation of the FAUT (.err) output file contents.
*/
class TLGCFautJsonData : public Serializable
{
public:
	explicit TLGCFautJsonData(const TLGCData &project);

	virtual void serialize(ObjectSerializer &obj) const override;

private:
	const TLGCData &fProject;
};
#endif // USE_SERIALIZER
