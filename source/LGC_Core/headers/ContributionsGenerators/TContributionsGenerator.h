...
public:
	...
	*/
	...
	//@{
		...
		/// Returns the contribution for the CMM measurement
		CMMContrib  getCMMContrib(const TCMM& cmm);
	//@}
...
private:
	...
	//@{
		...
		*/
		...
		/// Add conytributions for the LOR transformations for CMM measurements
		void addTransformationsContributions3Dcmm(const TLOR2LOR& lorTrafo, const TPositionVector& pointPos, const TFreeVector& line1AMat, const TFreeVector& line2AMat, const TFreeVector& line3AMat, std::vector<std::pair<TAdjustableHelmertTransformation, TransformationContrib3D>>& transfContrib);
