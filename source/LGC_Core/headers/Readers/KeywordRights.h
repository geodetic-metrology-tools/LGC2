...
const char *allowed_PLR3D[nb_allowed_plr3d] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_ANGL[nb_allowed_angl] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_ZEND[nb_allowed_zend] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_DIST[nb_allowed_dist] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_ECTH[nb_allowed_ecth] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_ECDIR[nb_allowed_ecdir] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_DHOR[nb_allowed_dhor] = {
	TSTN, PLR3D, ANGL, ZEND, DIST, ECTH, DHOR, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECDIR, ECVE, ORIE, RADI, OBSXYZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
// CAM measurments
...
const char *allowed_CALA[nb_allowed_cala] = {
	TSTN, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECVE, ORIE, RADI, OBSXYZ, POIN, VXY, VXZ, VYZ, VZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
const char *allowed_POIN[nb_allowed_poin] = {
	TSTN, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECVE, ORIE, RADI, OBSXYZ, CALA, VXY, VXZ, VYZ, VZ, FRAME, ENDFRAME, END, INCLY, ROLLY, ECWS, ECWI};
...
const char *allowed_POLAR[nb_allowed_polar] = {TSTN, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECVE, ORIE, RADI, OBSXYZ, CALA, POIN, VXY, VXZ, VYZ, VZ, PDOR, POLAR, CAMD, EDM,
	LEVEL, SCALE, INCL, FRAME, HLSR, WPSR, ECWS, ECWI};
...
const char *allowed_ENDFRAME[nb_allowed_ef] = {
	TSTN, CAM, DSPT, DLEV, DVER, ECHO, ECSP, ECVE, ORIE, RADI, CALA, POIN, VXY, VXZ, VYZ, VZ, FRAME, ENDFRAME, END, OBSXYZ, INCLY, ROLLY, ECWS, ECWI};
