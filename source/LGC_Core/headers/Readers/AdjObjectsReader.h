...
class TKeyFRAME : public TAKeyWord {
	public:
		...
		*/
		TKeyFRAME(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(FRAME));
...
class TKeyENDFRAME : public TAKeyWord {
	public:
		...
		TKeyENDFRAME(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(ENDFRAME));
...
class TKeyCALA : public TAPointKey {
	public:
		TKeyCALA(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(CALA));
	protected:
...
class TKeyPOIN : public TAPointKey {
	public:
		TKeyPOIN(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(POIN));
	protected:
		virtual LGCAdjustablePoint& insertPoint(const std::string& pointName, TReal x, TReal y, TReal z);
};
...
class TKeyVXY : public TAPointKey {
	public:
		TKeyVXY(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(VXY));
	protected:
		virtual LGCAdjustablePoint& insertPoint(const std::string& pointName, TReal x, TReal y, TReal z);
};
...
class TKeyVXZ : public TAPointKey {
	public:
		TKeyVXZ(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(VXZ));
...
class TKeyVYZ : public TAPointKey {
	public:
		TKeyVYZ(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(VYZ));
...
class TKeyVZ : public TAPointKey {
	public:
		TKeyVZ(TLGCData& project, const std::set<std::string> &allowed_kw = KeywordRights::lgc2Rights(VZ));
