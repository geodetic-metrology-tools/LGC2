...
public:
	...
	//@}
	virtual void setObsVector(const Eigen::VectorXd &obsVect) override { obsValue = TPositionVector(obsVect(0), obsVect(1), obsVect(2), TCoordSysFactory::ECoordSys::k3DCartesian); }
	virtual Eigen::VectorXd getObsVector() const override 
	{
		Eigen::VectorXd result(3);
