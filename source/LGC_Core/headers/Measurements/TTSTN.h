	...
	*/
	struct TROM : public TStatusObject {
		...
		*/
		...
		/*!
		\returns Summary of all the spatial offsets corresponding to ANGL measurements.
		\note This function can be called only when the calculation is finished and the residuals of the observations are already set.
		*/
		const TLGCObsSummary& getANGLOffsetsObsSummary() const;

		/*!
		\returns Summary of all the spatial offsets corresponding to ZEND measurements.
		\note This function can be called only when the calculation is finished and the residuals of the observations are already set.
		*/
		const TLGCObsSummary& getZENDOffsetsObsSummary() const;
	...
	private:
		...
		TLGCObsSummary anglOffsetsSummary_;  // Offsets in MM corresponding to horizontal angles
		TLGCObsSummary zendOffsetsSummary_;  // Offsets in MM corresponding to zenithal distances
