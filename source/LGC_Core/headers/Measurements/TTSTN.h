		...
		*/
		struct TROM : public TStatusObject {
			...
			*/
			...
			const TPOLARObsSummary& getPLR3DObsSummary(std::string text);
			...
			*/
			...
			const TLGCObsSummary& getANGLObsSummary(std::string text);
			...
			*/
			...
			const TLGCObsSummary& getZENDObsSummary(std::string text);
			...
			*/
			...
			const TLGCObsSummary& getDISTObsSummary(std::string text);
			...
			*/
			...
			const TLGCObsSummary& getECTHObsSummary(std::string text);
			...
			*/
			...
			const TLGCObsSummary& getECDIRObsSummary(std::string text);
