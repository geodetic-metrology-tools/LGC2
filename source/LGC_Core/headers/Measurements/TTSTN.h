...
struct TTSTN : public TStatusObject
{
	...
	*/
	struct TROM : public TStatusObject
	{
		...
		*/
		...
		TROM(std::string defTargetId, TAdjustableAngle *v0) : acst(0.0, TAngle::EUnits::kGons), v0(v0), defaultTargetId(defTargetId) {}
	...
	*/
	TTSTN(const LGCAdjustablePoint &pos, const TInstrumentData::TPOLAR &instrument) :
		instrument(instrument), instrumentPos(&pos), rot3D(false), ihfix(false), line(NO_VALi), instrumentHeightAdjustable(nullptr), rotX(nullptr), rotY(nullptr)
