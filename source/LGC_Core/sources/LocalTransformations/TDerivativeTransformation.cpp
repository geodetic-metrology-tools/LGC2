...
TDerivativeTransformation::TDerivativeTransformation() : fTransM(std::unique_ptr<Eigen::Matrix4d>(new Eigen::Matrix4d))
{
	fTransM->setZero();
}

TDerivativeTransformation::TDerivativeTransformation(const Eigen::Matrix4d &mat) : fTransM(std::unique_ptr<Eigen::Matrix4d>(new Eigen::Matrix4d(mat)))
{
}
