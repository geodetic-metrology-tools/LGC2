...
{
	return !measANGL.empty() || !measZEND.empty() || !measDIST.empty() || !measDHOR.empty() || !measECTH.empty() || !measECDIR.empty();
}

const TLGCObsSummary &TTSTN::TROM::getANGLObsSummary() const
{
	return anglSummary_;
}
...
const TLGCObsSummary &TTSTN::TROM::getZENDObsSummary() const
{
	return zendSummary_;
}
...
const TLGCObsSummary &TTSTN::TROM::getDISTObsSummary() const
{
	return distSummary_;
}
...
const TLGCObsSummary &TTSTN::TROM::getDHORObsSummary() const
{
	return dhorSummary_;
}
...
const TLGCObsSummary &TTSTN::TROM::getECTHObsSummary() const
{
	return ecthSummary_;
}
...
const TLGCObsSummary &TTSTN::TROM::getECDIRObsSummary() const
{
...
const TPOLARObsSummary &TTSTN::TROM::getPLR3DObsSummary() const
{
