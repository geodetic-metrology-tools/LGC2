...
//VERTICAL DISTANCE
//////////////////////////////////////////////////////////////////////////////////
void	TMesFileWriter::writeVertDist()
{//write spatial distance

	//TVertDistConverter converter (getStreamRef());
	////List
	//LSVertDistConstIter	obsIt, endObsIt;
	//obsIt			= getLSCalcDataSet()->beginLSVertDist();
	//endObsIt		= getLSCalcDataSet()->endLSVertDist();

	////Title
	//this->writeKeyWord(this->getKeyWord(TALGCConverter::kDVER));
	////write results
	//while(obsIt != endObsIt)
	//{
	//	converter.writeMesData(obsIt);	
