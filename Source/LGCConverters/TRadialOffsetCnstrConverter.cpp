...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
void	TRadialOffsetCnstrConverter::writeResultsHeader()
{
...
//READ FUNCTION
////////////////////////////////////////////////////////////////////////////////////////////////////
int TRadialOffsetCnstrConverter::readObservation(int i, TLGCProject* project)
{
	TAStreamFormatter*	stream = getStream();
...
//	TRadialOffsetCnstr* newCnstr = new TRadialOffsetCnstr;
	...
	while ((stream->peek()) != '*')
	{
		...
		else
		{
			...
			TRadialOffsetCnstr* newCnstr = new TRadialOffsetCnstr(project->getDataSet()->getObservationsCount()++, ptName, cWidth, cBearing);
