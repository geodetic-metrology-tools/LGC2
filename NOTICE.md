...
This project, **LGC**, includes third-party software components with their own licenses:
...
All license texts can be found in the `LICENSES/` directory. This file serves to document third-party components, but refer to individual license files for legal terms.